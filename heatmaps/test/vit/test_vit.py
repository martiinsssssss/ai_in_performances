...
import timm # Required for vit model's backbone
...
if __name__ == "__main__":
    JHU_CROWDPP_ROOT = 'code/heatmaps/archive'
    ...
    MODEL_CONFIGS = {
        'ViT_BCEWithLogitsLoss_Model': {
            'path': 'outputs/ViT/BCE/model.pth',
            'loss_type': 'bcewithlogits',
            'base_visualizations_path': 'model_test/ViT/visualizations'
        },
        'ViT_L1Loss_Model': {
            'path': 'outputs/ViT/L12/model.pth',
            'loss_type': 'l1',
            'base_visualizations_path': 'model_test/ViT/visualizations' 
        },
        'ViT_MSELoss_Model': {
            'path': 'outputs/ViT/MSE2/model.pth',
            'loss_type': 'mse',
            'base_visualizations_path': 'model_test/ViT/visualizations' 
        },
    }
