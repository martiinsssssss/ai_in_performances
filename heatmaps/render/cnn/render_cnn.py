...
INPUT_IMAGE_PATH = 'render/seated.jpg'
MODEL_INPUT_SIZE = (224, 224)
SCALE_FACTOR_HEIGHT = 20.0
RESOLUTION_SCALE_MODEL = 0.7
TEXTURE_FOLDER = 'render/render_out/textures/cliff_side_2k.blend/textures'
...
model_info = {
    'cnn_mse': 'CNN/MSE2/model_mse.pth',
    'cnn_l1': 'CNN/L1/model_l1.pth',
    'cnn_bce': 'CNN/BCE2/model_bcelogits.pth',
}

# 2. SimpleCNN Definition
...
def generate_heatmap_array_and_save_png_from_model(model_path, input_image_path, model_input_size,
    ...
    try:
        ...
        print("Ensure that the SimpleCNN class definition is correct and matches the saved model.")
        return None, None, None
...
def generate_3d_model_and_gif_from_heatmap(heatmap_array, output_base_name, scale_factor, resolution_scale,
    ...
    if save_visualization and vis_output_dir:
        ...
        if first_frame_to_save is not None:
            ...
            iio.imwrite(frame_output_path, first_frame_to_save)
...
if __name__ == "__main__":
    ...
    if needs_dummy_data:
        ...
        for model_key, model_path_dummy in model_info.items():
            ...
            if not os.path.exists(model_path_dummy):
                ...
                print(f"Dummy SimpleCNN model '{model_key}' created at '{model_path_dummy}'.")
    ...
    for model_name, model_path in model_info.items():
        ...
        if heatmap_array is not None:
            print(f"Generating 3D model and GIF for {model_name}...")
